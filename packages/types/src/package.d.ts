...
export type UpdatePackageItemRequest = Partial<Omit<CreatePackageItemRequest, 'packageId'>>;
...
export type UpdatePackageImageRequest = Partial<Omit<CreatePackageImageRequest, 'packageId'>>;

export type PropertyType = 'hotel' | 'resort' | 'apartment' | 'villa' | 'hostel' | 'other';
...
export type UpdatePropertyImageRequest = Partial<Omit<CreatePropertyImageRequest, 'propertyId'>>;
...
export type UpdateRoomImageRequest = Partial<Omit<CreateRoomImageRequest, 'roomId'>>;
...
export type UpdateRoomAvailabilityRequest = Partial<Pick<CreateRoomAvailabilityRequest, 'availableUnits' | 'priceCents'>>;

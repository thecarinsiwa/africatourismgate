...
export type UpdateItineraryRequest = Partial<Omit<CreateItineraryRequest, 'shipId'>>;
...
export type UpdateItineraryPortRequest = Partial<Omit<CreateItineraryPortRequest, 'itineraryId'>>;
...
export type UpdateCabinAvailabilityRequest = Partial<Pick<CreateCabinAvailabilityRequest, 'availableCount' | 'priceCents'>>;
...
export type UpdateShipImageRequest = Partial<Omit<CreateShipImageRequest, 'shipId'>>;

export type FlightClassName = 'economy' | 'premium_economy' | 'business' | 'first';
...
export type UpdateFlightImageRequest = Partial<Omit<CreateFlightImageRequest, 'flightId'>>;
...
export type UpdateFlightClassRequest = Partial<Omit<CreateFlightClassRequest, 'flightId'>>;
...
export type UpdateFlightClassAvailabilityRequest = Partial<Pick<CreateFlightClassAvailabilityRequest, 'availableSeats' | 'priceCents'>>;

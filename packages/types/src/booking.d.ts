...
export type BookingStatus = 'draft' | 'pending_approval' | 'pending_payment' | 'confirmed' | 'cancelled' | 'refunded';
export type BookingCheckoutItemType = 'room' | 'flight_class' | 'vehicle' | 'cabin' | 'activity_schedule';
export type BookingItemType = BookingCheckoutItemType | 'package';

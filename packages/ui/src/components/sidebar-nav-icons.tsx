...
export function SidebarMailIcon({ className }: IconProps) {
  return (
    <IconBase className={className}>
      <path
        strokeLinecap="round"
...
export function SidebarSlidersIcon({ className }: IconProps) {
  return (
    <IconBase className={className}>
      <path
        strokeLinecap="round"
...
export function SidebarBellIcon({ className }: IconProps) {
  return (
    <IconBase className={className}>
      <path
        strokeLinecap="round"

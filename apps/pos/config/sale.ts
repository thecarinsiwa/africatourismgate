export const posSalePageConfig = {
  ...
  manifest: {
    ...
    subtitleEmpty: 'Aucun voyageur renseigné (optionnel à la caisse)',
    ...
    seriousMedicalConditionsLabel: 'Conditions médicales graves',
    seriousMedicalConditionsPlaceholder: 'Ex. asthme, diabète…',
    currentMedicationsLabel: 'Traitements en cours',
    currentMedicationsPlaceholder: 'Ex. médicaments quotidiens…',
    dietaryNotesLabel: 'Notes alimentaires',

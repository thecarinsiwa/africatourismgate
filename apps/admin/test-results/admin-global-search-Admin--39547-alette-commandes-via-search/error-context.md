...
- Name: admin-global-search.spec.ts >> Admin global search >> finds help article palette-commandes via search
- Location: tests\e2e\admin-global-search.spec.ts:113:7

# Error details

```
Error: Échec login seed admin via API (401)
```

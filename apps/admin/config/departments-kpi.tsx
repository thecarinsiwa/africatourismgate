export const departmentsKpis = [
  ...
  {
    key: 'organizations',
    labelKey: 'stats.organizations.label',
    subtitleKey: 'stats.organizations.subtitle',
    href: '/organisations',
  ...
  {
    key: 'withDescription',
    labelKey: 'stats.withDescription.label',
    subtitleKey: 'stats.withDescription.subtitle',
...
export type DepartmentsKpiKey = (typeof departmentsKpis)[number]['key'];

...
export const adminDashboardNavConfig: AdminNavEntryConfig[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/produits/locations/agences', label: 'Agences location', iconKey: 'car' },
      { href: '/produits/locations/categories', label: 'Catégories véhicules', iconKey: 'car' },
      { href: '/produits/croisieres', label: 'Croisières', iconKey: 'ship' },
      { href: '/produits/croisieres/lignes', label: 'Lignes croisière', iconKey: 'ship' },
      { href: '/produits/croisieres/ports', label: 'Ports croisière', iconKey: 'ship' },
      { href: '/produits/croisieres/navires', label: 'Navires', iconKey: 'ship' },

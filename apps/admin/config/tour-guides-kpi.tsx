export const tourGuidesKpis = [
  ...
  {
    key: 'internal',
    labelKey: 'stats.internal.label',
    subtitleKey: 'stats.internal.subtitle',
  ...
  {
    key: 'external',
    labelKey: 'stats.external.label',
    subtitleKey: 'stats.external.subtitle',
    iconClass: 'bg-amber-100 text-amber-800 dark:bg-amber-950/50 dark:text-amber-300',
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden>
        <path
          strokeLinecap="round"
...
export type TourGuidesKpiKey = (typeof tourGuidesKpis)[number]['key'];

export const permissionsKpis = [
  ...
  {
    key: 'domains',
    labelKey: 'stats.domains.label',
    subtitleKey: 'stats.domains.subtitle',
  ...
  {
    key: 'actions',
    labelKey: 'stats.actions.label',
    subtitleKey: 'stats.actions.subtitle',
  ...
  {
    key: 'roles',
    labelKey: 'stats.roles.label',
    subtitleKey: 'stats.roles.subtitle',
    href: '/systeme/roles',
...
export type PermissionsKpiKey = (typeof permissionsKpis)[number]['key'];

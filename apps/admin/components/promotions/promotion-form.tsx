  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,22rem)] lg:items-start">
        ...
        <div className="grid min-w-0 gap-6 md:grid-cols-2 md:items-stretch lg:col-span-2">
          <Card variant="dashboard" padding="md" className="min-w-0 w-full space-y-4">
        ...
        <Card variant="dashboard" padding="md" className="min-w-0 space-y-4 lg:col-span-2">
        ...
        <div className="flex flex-wrap gap-3 border-t border-atg-border/60 pt-4 lg:col-span-2">

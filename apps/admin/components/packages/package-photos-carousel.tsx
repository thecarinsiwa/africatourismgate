...
import type { PackageImage } from '@africatourismgate/types';
...
type PackagePhotosCarouselProps = {
  images: PackageImage[];
  altFallback: string;
  className?: string;
};

export function PackagePhotosCarousel({
  images,
  altFallback,
  className,
}: PackagePhotosCarouselProps) {
  const t = useTranslations('modules.packages.view');

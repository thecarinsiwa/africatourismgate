    ...
    <main className="min-h-screen flex flex-col items-center justify-between text-white relative overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-6 px-4 md:px-8 w-full max-w-4xl mx-auto">
        ...
        <p className="text-sm sm:text-base md:text-lg font-light text-white/90 max-w-2xl mx-auto leading-relaxed pb-4">
          Our website is currently undergoing scheduled update for the new features.
        ...
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-8 pt-2 pb-6">
          {[
            ...
            <div
              key={i}
              className="flex flex-col items-center justify-center w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full bg-white text-slate-800 shadow-lg"
            >
        ...
        <div className="pt-2">
          <button
            type="button"
            className="bg-primary hover:bg-primary-hover text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-full uppercase tracking-wider text-xs sm:text-sm font-semibold transition-colors shadow-lg min-h-[44px]"
          >
            Notify Us
          </button>
        </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-end pb-8 sm:pb-10 w-full items-center">
        ...
        <div className="flex gap-2 sm:gap-3 flex-wrap justify-center px-4">
          <a
            ...
            className="w-8 h-8 rounded-full bg-[#3b5998] flex items-center justify-center hover:opacity-80 transition-opacity"
            aria-label="Facebook"
          >
          ...
          <a
            ...
            className="w-8 h-8 rounded-full bg-gradient-to-tr from-[#fd5949] to-[#d6249f] flex items-center justify-center hover:opacity-80 transition-opacity"

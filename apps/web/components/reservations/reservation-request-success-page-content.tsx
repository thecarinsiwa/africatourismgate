...
export function ReservationRequestSuccessPageContent() {
  ...
  return (
    ...
    >
      <div className="mt-6 rounded-xl border border-primary/30 bg-atg-elevated p-6 dark:border-primary/40 dark:bg-atg-elevated">

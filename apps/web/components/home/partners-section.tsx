...
export function PartnersSection() {
  ...
  return (
    <section ref={ref} className="border-y border-gray-100 bg-white py-12 sm:py-16">
          ...
          {PARTNERS.map((partner, i) => (
            ...
            >
              ...
              >
                ...
                <span className="text-xs text-gray-400 text-center group-hover:text-gray-600 transition-colors hidden sm:block">
                  {partner.name}
                </span>
              </a>
            </div>

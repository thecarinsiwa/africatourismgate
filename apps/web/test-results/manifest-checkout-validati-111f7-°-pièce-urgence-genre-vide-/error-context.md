...
- Name: manifest-checkout-validation.spec.ts >> manifeste checkout: OK avec nom + nationalité + n° pièce + urgence (genre vide)
- Location: tests\e2e\manifest-checkout-validation.spec.ts:162:5

...
export const HELP_CATEGORIES: readonly HelpCategory[] = [
  ...
  },
  {
    ...
    slug: 'payment',
    icon: 'card',
    articleSlugs: ['payment-methods', 'invoice-receipt', 'failed-payment'],
  },
  {
    id: 'cat-cancellation',
    slug: 'cancellation',
  ...
  },
  {
    ...
    slug: 'account',
    icon: 'user',
    articleSlugs: ['update-profile', 'password-security'],
  },
  {
    id: 'cat-contact',
    slug: 'contact',
...
export const HELP_ARTICLES: readonly HelpArticle[] = [
  ...
  },
  {
    ...
    categorySlug: 'payment',
    relatedSlugs: ['payment-methods'],
  },
  {
    id: 'art-failed-payment',
    slug: 'failed-payment',
    categorySlug: 'payment',
    relatedSlugs: ['payment-methods', 'how-to-contact'],
  },
  {
  ...
  },
  {
    ...
    popular: true,
    relatedSlugs: ['password-security'],
  },
  {
    id: 'art-password-security',
    slug: 'password-security',
    categorySlug: 'account',
    relatedSlugs: ['update-profile', 'how-to-contact'],
  },
  {

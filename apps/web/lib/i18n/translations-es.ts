...
export const es: Translations = {
  ...
  packages: {
    ...
    packageBookingHint:
      'Elija la fecha de salida: la fecha de regreso se calcula automáticamente ({days} día(s)). Los servicios incluidos se resuelven por usted.',
    selectDepartureHint: 'Indique una fecha de salida para preparar la reserva.',
    includedServicesTitle: 'Servicios resueltos automáticamente',
    ...
    startConfiguration: 'Configurar paquete',
    stepBack: 'Volver',
    viewRecap: 'Ver resumen',
    recapTitle: 'Resumen del paquete',
    recapHint: 'Revise cada servicio antes de añadir el paquete al carrito.',

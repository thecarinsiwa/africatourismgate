...
export const es: Translations = {
  ...
  blog: {
    metaTitle: 'Diarios de viaje en África',
    metaDescription:
      'Historias, guías e inspiración para planificar su próximo viaje a África con Africa Tourism Gate.',
    heroTitle: 'Diarios de viaje',
    heroSubtitle:
      'Relatos, consejos e inspiración para explorar África — safaris, playas y culturas.',
    heroBadge: 'Inspiración',
    cardBadge: 'Relato',
    featuredLabel: 'Destacado',
    storiesLabel: 'Todos los relatos',
    storiesHint: 'Ideas prácticas para preparar su próxima estancia en el continente.',
    articlesCount: 'artículos',
    explorePackages: 'Descubrir nuestros paquetes',
    relatedTitle: 'Seguir leyendo',
    relatedHint: 'Más ideas para su próximo viaje.',
    readMore: 'Leer más',

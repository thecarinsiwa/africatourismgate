...
echo "  6. URLs:"
echo "       Site public : https://africatourismgate.org/        (atg-web, port 3002)"
echo "       Admin       : https://app-africatourismgate.org/login (atg-admin, port 3001)"
echo "  7. Optional POS: ATG_ENABLE_POS=1 pm2 start ecosystem.config.cjs --only atg-pos"
echo "  8. Optional GAP: ATG_ENABLE_GAP=1 pm2 start ecosystem.config.cjs --only atg-gap"
echo ""
echo "  pm2 status"

...
CREATE TABLE `email_operation_verifications` (
  `id` CHAR(36) NOT NULL,
  `email` VARCHAR(255) NOT NULL,
...
CREATE TABLE `properties` (
  ...
  KEY `idx_properties_org` (`organization_id`),
  ...
  CONSTRAINT `fk_properties_org` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `flights` (
  ...
  KEY `idx_flights_org` (`organization_id`),
  ...
  CONSTRAINT `fk_flights_org` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `vehicles` (
  ...
  KEY `idx_vehicles_org` (`organization_id`),
  ...
  CONSTRAINT `fk_vehicles_org` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `cabins` (
  ...
  KEY `idx_cabins_org` (`organization_id`),
  KEY `idx_cabins_deleted_at` (`deleted_at`),
  CONSTRAINT `fk_cabins_ship` FOREIGN KEY (`ship_id`) REFERENCES `ships` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_cabins_org` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `activity_itinerary_stops` (
  `id` CHAR(36) NOT NULL,
  `activity_id` CHAR(36) NOT NULL,
  ...
  CONSTRAINT `fk_activity_itinerary_stops_activity` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_activity_itinerary_stops_created_by` FOREIGN KEY (`created_by_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_activity_itinerary_stops_updated_by` FOREIGN KEY (`updated_by_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
